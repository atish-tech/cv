    ...
    <div className="border bg-card text-card-foreground p-3 shadow-sm md:rounded-lg flex justify-between items-center top-0 sticky z-50">
      ...
      <div className="space-x-3 items-center">
        <Button
          variant="outline"
          size="sm"
          onClick={() => window.open("https://github.com/atish-tech", "_blank")}
        >
        ...
        <Button
          ...
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/atish-thakur-8b54241b2/",
              "_blank"
            )
          }
        >
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={() => window.open("mailto:katish332@gmail.com", "_blank")}
        >
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={() => window.open("tel:+91 8578975214", "_blank")}
        >
